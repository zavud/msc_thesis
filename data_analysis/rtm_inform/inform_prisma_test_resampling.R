...
# inform simulation
LUT_columns = c(df_prisma_sensor$center, "Cab", "Cw", "Cm", "LAI", "cd")
...
for (i in 1:nrow(combinations)) {
        ...
        LUT[i, ] = c(m, parameters)
        
        if (i %% 1000 == 0) {
                message(paste0("=== Simulation number ", i, " finished running ==="))
        }
...
# Time difference of 1.593655 hours
# it took 1.593655 hours to run 100000 simulations with resampling on my computer
