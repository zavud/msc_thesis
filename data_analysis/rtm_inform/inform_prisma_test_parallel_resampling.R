...
# Time difference of 43.39541 mins
# with parallel computation it took the computer 43.39541 mins
# 1.159701 hours faster than the original base R loop! YAAAAY! =))
