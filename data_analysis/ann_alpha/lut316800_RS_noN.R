...
model %>% save_model_tf(filepath = "./data_analysis/models/ann_RS_noN_lut316800_3h")
history %>% as_tibble() %>% drop_na() %>% write_csv(file = "./data_analysis/models/history_ann_RS_noN_lut316800_3h.txt")
