...
combinations = readr::read_csv(".\\data_analysis\\inform_prisma\\combinations_data\\combinations_336960_2.txt")
...
dimnames(lut) = NULL
s_writing = Sys.time()
readr::write_csv(dplyr::as_tibble(lut), file = ".\\data_analysis\\inform_prisma\\lut_database\\lut336960_2_inform5_alpha.txt")
e_writing = Sys.time()
e_writing - s_writing