...
pca_recipe = recipe(training, ~.) %>% 
        update_role(236:239, new_role = "id") %>% 
...
write_csv(pca_training, file = "C:\\Users\\zavud\\Desktop\\msc_thesis\\data_analysis\\desis_training_database\\pca_training.txt")
write_csv(pca_validation, file = "C:\\Users\\zavud\\Desktop\\msc_thesis\\data_analysis\\desis_training_database\\pca_validation.txt")
write_csv(pca_testing, file = "C:\\Users\\zavud\\Desktop\\msc_thesis\\data_analysis\\desis_training_database\\pca_testing.txt")
