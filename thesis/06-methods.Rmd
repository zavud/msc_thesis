...
First, the full data set was shuffled and about 20% of the data was randomly sampled and assigned to validation and testing sets (10% validation, 10% testing sets). Random sampling makes sure there is no any pattern in any of the divided data sets.
