annprisma = DiagrammeR::grViz("digraph G {
    rankdir = LR;
    splines=false;
    edge[style=invis];
    ranksep= 1.4;
    ...
    x1 [label=<B<sub>1</sub>>];
    x2 [label=<B<sub>2</sub>>];
    x3 [label=<B<sub>3</sub>>];
    E0 [shape=none  label='&#8942;' fontsize=30 fillcolor=white];
    x5 [label=<B<sub>231</sub>>];
}
{
    ...
    a2562 [label=<a<sub>512</sub><sup>(1)</sup>>];
    ...
    a2563 [label=<a<sub>512</sub><sup>(2)</sup>>];
    ...
    a2564 [label=<a<sub>512</sub><sup>(3)</sup>>];
}
{
    ...
    {x1; x2; x3; E0; x5} -> {a12;a22;a32;E1;a2562};
