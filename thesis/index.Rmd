...
## thesis metadata ##
#####################
title: Using a Coupled Radiative Transfer Model and Artifical Neural Networks to Retrieve Forest Biochemical and Biophysical Maps from Remote Sensing Data
author: |
        | Author:
...
university: |
            ...
            |
            | University of Trier
university-logo: templates/uni-logo.png
submitted-text: Submitted in partial fulfillment of the requirements for the degree of Master of Science in
...
gap-before-crest: 12mm
gap-after-crest: 12mm
...
natbib-bibliography-style: templates/myplainnat.bst #or plainnat or some .bst file you download 
