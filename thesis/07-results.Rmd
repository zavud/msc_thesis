...
```{r losstable, echo=FALSE, message=FALSE, warning=FALSE}
...
This result indicates that, when designing the NN architecture properly and giving reasonable amount of hidden layers and units, the NN model can deal with multicollinearity very efficiently. Most of the previous studies concluded that 
