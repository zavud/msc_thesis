...
```{r meancomparison, warning=FALSE, message=FALSE, echo=FALSE, out.width="80%", fig.align='center', fig.cap="Difference between averaged LUT and PRISMA image reflectance"}
